...
?>
	...
	<div>
	  ...
	  <ul class="nav nav-tabs" role="tablist">
	    ...
	    <li role="presentation"><a href="../admin/rangking-baru.php" role="tab">Tambah Data</a></li>
	  </ul>
	    ...
	    <div role="tabpanel" class="tab-pane active" id="lihat">
			...
			<div class="row">
				...
				<div class="col-md-6 text-right">
		            <button type="button" onclick="location.href='../admin/rangking-baru.php'" class="btn btn-primary">Tambah Data</button>
				</div>
			</div>
			<br/>
		...
		?>
		            <tr>
		                ...
		                <td class="text-center" style="vertical-align:middle;">
							<a href="../admin/rangking-ubah.php?ia=<?php echo $row['id_alternatif'] ?>&ik=<?php echo $row['id_kriteria'] ?>" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
							<a href="../admin/rangking-hapus.php?ia=<?php echo $row['id_alternatif'] ?>&ik=<?php echo $row['id_kriteria'] ?>" onclick="return confirm('Yakin ingin menghapus data')" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
					    </td>
		            </tr>
		<?php
		}
