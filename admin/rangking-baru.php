			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-md-6 text-right">
						<h3>
							<button type="button" onclick="location.href='../admin/rangking.php'" class="btn btn-success">Kembali</button>
						</h3>
					</div>
				</div>
				...
				<form method="post">
					...
					<div class="form-group">
						...
						<select class="form-control" id="ik" name="ik" onchange=ambildata(this.value) required>
					...
					<div class="form-group">
						<div class="form-group">
							...
							<select class="form-control" id="nn" name="nn" required>
